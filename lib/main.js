...
async function init() {
    const tonweb = new TonWeb(new TonWeb.HttpProvider('https://testnet.toncenter.com/api/v2/jsonRPC', {apiKey: '07e6c258b2602296de0c49b896a318dd322fa36e0ddca38ca011d1154f6dc0e4'}));
    var seed = "wrist three resource explain village cause matrix dismiss mansion matrix dash post nurse coral spoil enough carry cream soldier spring reopen install rocket hidden"
    let arr = seed.split(' ');
    ...
    const nftCollection = new NftCollection(tonweb.provider, {
        ...
        collectionContentUri: 'https://gateway.pinata.cloud/ipfs/QmSu6vCWF4rNYT7nTopEanDR15PmGXFa2EgxJqUnZwZRxb',
        nftItemContentBaseUri: 'https://gateway.pinata.cloud/ipfs/QmW1csadNd7j8xghxzf2xJgXwMykbLzfbDSCDnTbz92oVg',
    ...
    const nftByIndex = async () => {
        const addressByIndex = await nftCollection.getNftItemAddressByIndex(0);
    ...
    const addressNftItem = await nftByIndex();
